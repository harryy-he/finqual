...
class Ticker():
    ...
    def income1(self, start, end, quarter = None, readable = None, category = "cashflow"):
        ...
        node_names = ["Revenues", "Cost of Revenue", "Gross Profit", "Operating Expenses", "Cost and Expenses", "Operating Profit"
        ...
        if quarter == True:
            ...
            for i in np.arange(start,end+1):
                ...
                try:
                    ...
                    totals = [df1.loc[i].sum() for i in df1.index] #Summing across income statement items for a given year's quarters
            ...
            df.loc["Cost of Revenue"] = [df.loc["Revenues"][str(i) + "Q" + str(j)] - df.loc["Gross Profit"][str(i) + "Q" + str(j)] for i in np.arange(end, start-2, -1) for j in np.arange(4,0, -1)]
        
            df.loc["Operating Expenses"] = [df.loc["Gross Profit"][str(i) + "Q" + str(j)] - df.loc["Operating Profit"][str(i) + "Q" + str(j)] for i in np.arange(end, start-2, -1) for j in np.arange(4,0, -1)]

            df.loc["Non-Operating Income/Expense"] = [df.loc["Pretax Profit"][str(i) + "Q" + str(j)] - df.loc["Operating Profit"][str(i) + "Q" + str(j)] for i in np.arange(end, start-2, -1) for j in np.arange(4,0, -1)]   

            df.loc["EBIT"] = [df.loc["Net Profit"][str(i) + "Q" + str(j)] + df.loc["Tax"][str(i) + "Q" + str(j)] + df.loc["Interest Expense"][str(i) + "Q" + str(j)]for i in np.arange(end, start-2, -1) for j in np.arange(4,0, -1)]
            
            df.loc["EBITDA"] = [df.loc["EBIT"][str(i) + "Q" + str(j)] + df.loc["Depreciation and Amortization"][str(i) + "Q" + str(j)] for i in np.arange(end, start-2, -1) for j in np.arange(4,0, -1)]
            ...
            df.loc["Cost of Revenue"] = [df.loc["Revenues"][i] - df.loc["Gross Profit"][i] for i in np.arange(end, start-2, -1)]
            
            for i in df.columns:
                if (df.loc["Cost of Revenue", i] == 0 and df.loc["Cost and Expenses", i] != 0 and df.loc["Operating Expenses", i] != 0):
                    df.loc["Cost of Revenue", i] = df.loc["Cost and Expenses", i] - df.loc["Operating Expenses", i]
                    
            df.loc["Gross Profit"] = [df.loc["Revenues"][i] - df.loc["Cost of Revenue"][i] for i in np.arange(end, start-2, -1)]
            
            for i in df.columns:
                if (df.loc["Operating Profit", i] == 0 and df.loc["Operating Expenses", i] != 0 and df.loc["Gross Profit", i] != 0):
                    df.loc["Operating Profit", i] = df.loc["Gross Profit", i] - df.loc["Operating Expenses", i]

            df.loc["Operating Expenses"] = [df.loc["Gross Profit"][i] - df.loc["Operating Profit"][i] for i in np.arange(end, start-2, -1)]

            df.loc["Non-Operating Income/Expense"] = [df.loc["Pretax Profit"][i] - df.loc["Operating Profit"][i] for i in np.arange(end, start-2,-1)]
            
            df.loc["EBIT"] = [df.loc["Net Profit"][i] + df.loc["Tax"][i] + df.loc["Interest Expense"][i] for i in np.arange(end, start-2, -1)] 
            
            df.loc["EBITDA"] = [df.loc["EBIT"][i] + df.loc["Depreciation and Amortization"][i] for i in np.arange(end, start-2, -1)] 
    ...
    def cashflow(self, start, end, quarter = None, readable = None, category = "cashflow"):
        ...
        if quarter == True:
            ...
            df.loc["Free Cash Flow"] = [df.loc["Operating Cash Flow"][str(i) + "Q" + str(j)] - df.loc["Capital Expenditures"][str(i) + "Q" + str(j)] for i in np.arange(end, start-1, -1) for j in np.arange(4,0, -1)]
            ...
            df.loc["Free Cash Flow"] = [df.loc["Operating Cash Flow"][i] - df.loc["Capital Expenditures"][i] for i in np.arange(end, start-1, -1)]
    ...
    def balance(self, start, end, quarter = None, readable = None):
        ...
        node_names = ["Cash and Cash Equivalents", "Short-term Investments", "Accounts Receivable, Net", "Inventories", "Other Current Assets","Total Current Assets", 
                      "Property Plant and Equipment", "Intangibles", "Other Non-Current Assets" ,"Total Non-Current Assets", 
                      "Accounts Payable", "Accrued Liabilities", "Deferred Revenue","Short-term Borrowings", "Other Current Liabilities","Total Current Liabilities", 
                      "Long-Term Debt","Non-Debt Long Term Liabilities","Total Non-Current Liabilities",
                      "Capital Stock","Additional Paid In Capital", "Retained Earnings", "Accumulated Other Change","Stockholder's Equity", "Minority Interest", 
        ...
        if quarter == True:
            ...
            Sense-checking
            """
            df.loc["Total Non-Current Assets"] = [df.loc["Total Assets"][str(i) + "Q" + str(j)] - df.loc["Total Current Assets"][str(i) + "Q" + str(j)] for i in np.arange(end, start-1, -1) for j in np.arange(4,0, -1)]
            df.loc["Other Current Assets"] = [df.loc["Total Current Assets"][str(i) + "Q" + str(j)] - df.iloc[0:4][str(i) + "Q" + str(j)].sum() for i in np.arange(end, start-1, -1) for j in np.arange(4,0, -1)]
            df.loc["Other Non-Current Assets"] = [df.loc["Total Non-Current Assets"][str(i) + "Q" + str(j)] - df.iloc[6:7][str(i) + "Q" + str(j)].sum() for i in np.arange(end, start-1, -1) for j in np.arange(4,0, -1)]
            
            
            df.loc["Other Current Liabilities"] = [df.loc["Total Current Liabilities"][str(i) + "Q" + str(j)] - df.iloc[11:15][str(i) + "Q" + str(j)].sum() for i in np.arange(end, start-1, -1) for j in np.arange(4,0, -1)]
            df.loc["Total Non-Current Liabilities"] = [df.loc["Total Liabilities"][str(i) + "Q" + str(j)] - df.loc["Total Current Liabilities"][str(i) + "Q" + str(j)].sum() for i in np.arange(end, start-1, -1) for j in np.arange(4,0, -1)]
            df.loc["Non-Debt Long Term Liabilities"] = [df.loc["Total Non-Current Liabilities"][str(i) + "Q" + str(j)] - df.loc["Long-Term Debt"][str(i) + "Q" + str(j)].sum() for i in np.arange(end, start-1, -1) for j in np.arange(4,0, -1)]
            
            
            df.loc["Accumulated Other Change"] = [df.loc["Stockholder's Equity"][str(i) + "Q" + str(j)] - df.iloc[21:24][str(i) + "Q" + str(j)].sum() for i in np.arange(end, start-1, -1) for j in np.arange(4,0, -1)]
            df.loc["Minority Interest"] = [df.loc["Total Equity"][str(i) + "Q" + str(j)] - df.loc["Stockholder's Equity"][str(i) + "Q" + str(j)].sum() for i in np.arange(end, start-1, -1) for j in np.arange(4,0, -1)]
            ...
            Sense-checking
            """
            df.loc["Total Non-Current Assets"] = [df.loc["Total Assets"][i] - df.loc["Total Current Assets"][i] for i in np.arange(end, start-1, -1)]
            df.loc["Other Current Assets"] = [df.loc["Total Current Assets"][i] - df.iloc[0:4][i].sum() for i in np.arange(end, start-1, -1)]
            df.loc["Other Non-Current Assets"] = [df.loc["Total Non-Current Assets"][i] - df.iloc[6:7][i].sum() for i in np.arange(end, start-1, -1)]
            
            
            df.loc["Other Current Liabilities"] = [df.loc["Total Current Liabilities"][i] - df.iloc[11:15][i].sum() for i in np.arange(end, start-1, -1)]
            df.loc["Total Non-Current Liabilities"] = [df.loc["Total Liabilities"][i] - df.loc["Total Current Liabilities"][i].sum() for i in np.arange(end, start-1, -1)]
            df.loc["Non-Debt Long Term Liabilities"] = [df.loc["Total Non-Current Liabilities"][i] - df.loc["Long-Term Debt"][i].sum() for i in np.arange(end, start-1, -1)]
            
            
            df.loc["Accumulated Other Change"] = [df.loc["Stockholder's Equity"][i] - df.iloc[19:22][i].sum() for i in np.arange(end, start-1, -1)]
            df.loc["Minority Interest"] = [df.loc["Total Equity"][i] - df.loc["Stockholder's Equity"][i].sum() for i in np.arange(end, start-1, -1)]
...
ide2_10 = Node("GainsLossesOnExtinguishmentOfDebtBeforeWriteOffOfDeferredDebtIssuanceCost", attribute = "credit", parent = ide1_2)
...
ide5_14 = Node("InterestExpenseFederalHomeLoanBankAndFederalReserveBankAdvancesLongTerm", attribute = "debit", parent = ide4_7)
...
ca2_14 = Node("FinancingReceivableExcludingAccruedInterestBeforeAllowanceForCreditLossCurrent", attribute = "debit", parent = ca1_24)
ca2_15 = Node("FinancingReceivableAllowanceForCreditLossExcludingAccruedInterestCurrent", attribute = "credit", parent = ca1_24)

ca2_16 = Node("DebtSecuritiesHeldToMaturityExcludingAccruedInterestBeforeAllowanceForCreditLossCurrent", attribute = "debit", parent = ca1_25)
ca2_17 = Node("DebtSecuritiesHeldToMaturityAllowanceForCreditLossExcludingAccruedInterestCurrent", attribute = "credit", parent = ca1_25)

ca2_18 = Node("NetInvestmentInLeaseExcludingAccruedInterestBeforeAllowanceForCreditLossCurrent", attribute = "debit", parent = ca1_26)
ca2_19 = Node("NetInvestmentInLeaseAllowanceForCreditLossExcludingAccruedInterestCurrent", attribute = "credit", parent = ca1_26)
...
ca2_25 = Node("DisposalGroupIncludingDiscontinuedOperationAccountsNotesAndLoansReceivableNet", attribute = "debit", parent = ca1_29)
ca2_26 = Node("DisposalGroupIncludingDiscontinuedOperationGoodwillCurrent", attribute = "debit", parent = ca1_29)
ca2_27 = Node("DisposalGroupIncludingDiscontinuedOperationPropertyPlantAndEquipmentCurrent", attribute = "debit", parent = ca1_29)
...
ca4_5 = Node("DebtSecuritiesHeldToMaturityAmortizedCostAfterAllowanceForCreditLossCurrent", attribute = "debit", parent = ca3_5)
...
nca1_5 = Node("AccountsReceivableExcludingAccruedInterestAfterAllowanceForCreditLossNoncurrent", attribute = "debit", parent = nca)
nca1_6 = Node("FinancingReceivableExcludingAccruedInterestAfterAllowanceForCreditLossNoncurrent", attribute = "debit", parent = nca)
...
nca2_29 = Node("AccumulatedDepreciationDepletionAndAmortizationPropertyPlantAndEquipment", attribute = "credit", parent = nca1_13)
...
nca2_59 = Node("DisposalGroupIncludingDiscontinuedOperationIntangibleAssetsNoncurrent", attribute = "debit", parent = nca1_29)
nca2_60 = Node("DisposalGroupIncludingDiscontinuedOperationGoodwillNoncurrent", attribute = "debit", parent = nca1_29)
nca2_61 = Node("DisposalGroupIncludingDiscontinuedOperationPropertyPlantAndEquipmentNoncurrent", attribute = "debit", parent = nca1_29)
...
nca3_14 = Node("OilAndGasPropertySuccessfulEffortMethodAccumulatedDepreciationDepletionAndAmortization", attribute = "credit", parent = nca2_31)
...
nca4_4 = Node("DebtSecuritiesHeldToMaturityAmortizedCostAfterAllowanceForCreditLossNoncurrent", attribute = "debit", parent = nca3_17)
...
nca5_3 = Node("ConstructionContractorReceivableIncludingContractRetainageAfterYearOne", attribute = "debit", parent = nca4_5)
...
cl3_43 = Node("FederalHomeLoanBankAdvancesMaturitiesSummaryDueWithinOneYearOfBalanceSheetDate",attribute = "credit", parent = cl2_9)
...
cl3_55 = Node("JuniorSubordinatedDebentureOwedToUnconsolidatedSubsidiaryTrustCurrent",attribute = "credit", parent = cl2_10)
...
cl4_3 = Node("TaxCutsAndJobsActOf2017TransitionTaxForAccumulatedForeignEarningsLiabilityCurrent", attribute = "credit", parent = cl3_32)
...
ncl3_25 = Node("PensionAndOtherPostretirementAndPostemploymentBenefitPlansLiabilitiesNoncurrent", attribute = "credit", parent = ncl2_3)
...
ncl3_36 = Node("LiabilitiesOfBusinessTransferredUnderContractualArrangementNoncurrent", attribute = "credit", parent = ncl2_3)
...
ncl4_12 = Node("DeferredCompensationSharebasedArrangementsLiabilityClassifiedNoncurrent", attribute = "credit", parent = ncl3_18)
ncl4_13 = Node("DeferredCompensationCashbasedArrangementsLiabilityClassifiedNoncurrent", attribute = "credit", parent = ncl3_18)
...
ncl4_20 = Node("PensionAndOtherPostretirementDefinedBenefitPlansLiabilitiesNoncurrent", attribute = "credit", parent = ncl3_25)
...
ncl4_29 = Node("DisposalGroupIncludingDiscontinuedOperationDeferredRevenueNoncurrent", attribute = "credit", parent = ncl3_35)
ncl4_30 = Node("DisposalGroupIncludingDiscontinuedOperationOtherNoncurrentLiabilities", attribute = "credit", parent = ncl3_35)
ncl4_31 = Node("DisposalGroupIncludingDiscontinuedOperationPensionPlanBenefitObligationNoncurrent", attribute = "credit", parent = ncl3_35)
ncl4_32 = Node("DisposalGroupIncludingDiscontinuedOperationPostretirementPlanBenefitObligationNoncurrent", attribute = "credit", parent = ncl3_35)
ncl4_33 = Node("DisposalGroupIncludingDiscontinuedOperationAccruedIncomeTaxPayableNoncurrent", attribute = "credit", parent = ncl3_35)
...
ncl5_9 = Node("TaxCutsAndJobsActOf2017TransitionTaxForAccumulatedForeignEarningsLiabilityNoncurrent", attribute = "credit", parent = ncl4_4)
...
se3_5 = Node("AccumulatedOtherComprehensiveIncomeLossForeignCurrencyTranslationAdjustmentNetOfTax", attribute = "credit", parent = se2_11)
se3_6 = Node("AccumulatedOtherComprehensiveIncomeLossAvailableForSaleSecuritiesAdjustmentNetOfTax", attribute = "credit", parent = se2_11)
se3_7 = Node("AociLossCashFlowHedgeCumulativeGainLossAfterTax", attribute = "credit", parent = se2_11)
se3_8 = Node("AccumulatedOtherComprehensiveIncomeLossDefinedBenefitPensionAndOtherPostretirementPlansNetOfTax", attribute = "debit", parent = se2_11)
se3_9 = Node("AccumulatedOtherComprehensiveIncomeLossFinancialLiabilityFairValueOptionAfterTax", attribute = "credit", parent = se2_11)
...
#Level 4
se4_1 = Node("DefinedBenefitPlanAccumulatedOtherComprehensiveIncomeNetGainsLossesAfterTax", attribute = "credit", parent = se3_8)
se4_2 = Node("DefinedBenefitPlanAccumulatedOtherComprehensiveIncomeNetPriorServiceCostCreditAfterTax", attribute = "debit", parent = se3_8)
se4_3 = Node("DefinedBenefitPlanAccumulatedOtherComprehensiveIncomeNetTransitionAssetsObligationsAfterTax", attribute = "credit", parent = se3_8)
...
cce3_2 = Node("AdjustmentsToReconcileNetIncomeLossToCashProvidedByUsedInOperatingActivities", attribute = "debit", parent = cce2_3)
...
cce4_2 = Node("IncomeTaxExpenseBenefitContinuingOperationsDiscontinuedOperationsExtraordinaryItems", attribute = "debit", parent = cce3_1)
